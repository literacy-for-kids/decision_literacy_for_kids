# Decision Literacy Curriculum - Docusaurus Website

This website contains a comprehensive 18-week Decision Literacy Curriculum designed for kids. It's built with [Docusaurus](https://docusaurus.io/), a modern static website generator.
...
- **Weeks 5-8**: Building Skills & Applying Knowledge
- **Weeks 9-11**: Deeper Thinking
- **Weeks 12-14**: Expanding Perspectives
- **Weeks 15-18**: Final project design, build, revision, and showcase
- **Optional Extension Weeks**: Bonus content
...
3. Join our [GitHub Discussions](https://github.com/literacy-for-kids/decision_literacy_for_kids/discussions)
