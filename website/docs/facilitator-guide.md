...
|---|---|---|
| Warm-up | 1-2 min | Ask an opening question from life or imagination |
| Concept | 3-5 min | Brief explanation using a concrete example |
| Scenario | 2-3 min | Work through the lesson's scenario together |
| Discussion | 5-10 min | Ask questions, listen, follow up |
| Close | 1-2 min | Decision Journal or exit prompt |
