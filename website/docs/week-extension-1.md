...
| A YouTube video claims it | 1-2 | Anyone can make a video |
| You tried it 50 times and tracked data | 4-5 | Your own systematic evidence |
...
| Belief | Confidence Before | New Evidence | Evidence Strength | Confidence After |
|---|---|---|---|---|
| | | | | |
