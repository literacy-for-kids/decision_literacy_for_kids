...
title: "Decision Literacy Glossary"
description: "Kid-friendly definitions for every key term in the Decision Literacy for Kids curriculum."
---

# Decision Literacy Glossary
...
|---|---|---|
| **100 Times Test** | A mental trick for evaluating risky choices: ask "If I did this 100 times, would I come out ahead overall?" It helps separate one-time luck from long-run patterns. | Week 9 |
| **5 Whys** | A problem-solving technique where you ask "Why?" five times in a row to dig past surface symptoms and find the true root cause of a problem. | Week 15 |
...
| **Escalation** | Continuing to invest more resources into a failing plan because you have already put so much in — making the sunk cost fallacy worse over time. | Week 7 |
| **Expected value (EV)** | The average outcome you can expect if you made the same choice many times. Calculated by multiplying each possible outcome by its probability, then adding everything up. | Week 9 |
| **Framing effect** | How the way a choice is described changes how you feel about it — even when the facts are identical. "90% chance of surviving" and "10% chance of dying" are the same, but feel very different. | Week 6 |
| **Frequency** | How often something happens over many tries. Thinking in frequencies ("3 out of 10 times") is more reliable than thinking in vague labels like "sometimes" or "rarely." | Week 3 |
| **Friction point** | A specific moment or obstacle that regularly gets in the way of a good habit or decision. Finding your friction point is the first step to fixing it. | Week 15 |
| **Heuristic** | A mental shortcut your brain uses to make quick decisions without doing a full analysis. Heuristics are usually helpful but can cause systematic errors in certain situations. | Week 5 |
...
| **Pre-mortem** | Imagining that your plan has failed and then asking "what went wrong?" before you start. It helps you spot weaknesses before they become real problems. | Week 16 |
| **Prediction** | A statement about what you think will happen in the future, ideally with a confidence level attached. Predictions that get recorded and checked help you improve your thinking over time. | Week 1 |
...
| **Sustainability** | Using a shared resource at a rate that allows it to replenish, so future users can benefit too. | Week 14 |
| **Tragedy of the commons** | What happens when individuals acting in self-interest overuse a shared resource and destroy it for everyone — even though no single person intended that outcome. | Week 14 |
| **Trigger** | A specific situation or signal that tells you to follow your protocol. For example, "When I feel the urge to quit, I will ask the magic question before deciding." | Week 16 |
| **Two-way door** | A decision you can reverse if it turns out to be wrong — like trying a new route to school or ordering something new at a restaurant. Two-way doors allow for experimentation. | Week 11 |
